public class days {
    ...
    public void setPhone(float phone) {this.phone = phone;}

    public float getFruit() {return fruit;}
    public void setFruit(float fruit) {this.fruit = fruit;}

    public float getVegetables() {return vegetables;}
    public void setVegetables(float vegetables) {this.vegetables = vegetables;}

    public float getCaffeine() {return caffeine;}
    ...
    public float getModerate() {return moderate;}
    public void setModerate(float moderate) {this.moderate = moderate;}
